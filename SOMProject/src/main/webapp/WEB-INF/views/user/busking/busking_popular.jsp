...
function bb(genre){
	window.location=genre+'.do?m_genre='+genre;
}
</script>
	...
	<section>
		...
		<div id="list" class="tab">
			<ul class="music">
				...
				<li><button class="tablinks" onclick="bb('busking_new');">NEW</button></li>
				<li><button class="active" onclick="bb('busking_popular');">POPULAR</button></li>
		...
		<c:forEach var="musicVo" items="${list}" varStatus="status">
			<tr>
				...
				<td><input type="button" value="구매" onclick="window.open('buy.do?path=${musicVo.b_path}&fileName=${musicVo.b_name}','get','height=500px, width=500px')"></td>
