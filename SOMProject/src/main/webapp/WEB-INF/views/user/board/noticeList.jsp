					...
					<c:forEach var="vo" items="${boardList }">
						<tr>
							...
							<td align="left"><a align="center"
								href="noticeContent.do?num=${vo.num}&pageNum=${bp.cur_Page}">${vo.subject}</a>
							</td>
			...
			<div class="pagination">
				...
				<c:forEach var="counter" begin="${bp.getPage_Start() }"
					...
					<c:if test="${search_text ne ''}">
						<a
							href="javascript:window.location='noticeList.do?pageNum=${counter }&search_type=${search_type}&search_text=${search_text}'">
							[${counter }]</a>
					</c:if>
					<c:if test="${search_text eq ''}">
						<a
							href="javascript:window.location='noticeList.do?pageNum=${counter }'">
							[${counter }]</a>
					</c:if>
				</c:forEach>
				<c:if test="${bp.isNext() }">
