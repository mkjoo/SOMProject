...
<input type="button" value="글삭제" onclick="window.location='freeBoardDeleteProc.mdo?num=${vo.num}'" />
</c:if>
...
<c:forEach var="commentList" items="${list}" varStatus="number">
	...
	<input type="button" value="수정 취소" onclick="window.location='freeboardList.do'">
	</c:if>
	</form>
