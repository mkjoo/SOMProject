		...
		<ul class="header_menu_ul" style="color: white">
			<li class="menu">
				<div class="dropdown">
					<button onclick="myFunction()" class="dropbtn">
						<img onclick="myFunction()" src="/som/images/main/메뉴바.png"
			...
			<li class="menu">
				<ul class="logo_search">
					<li><a href="userMainPage_home.do" title="Home"
			...
			<li class="menu"><c:if test="${loginID eq null}">
					<button id="myBtn">Login/Join</button>
				</c:if> <c:if test="${loginID ne null}">${loginID.name}님 환영</c:if> <c:if
					test="${loginID ne null}">
				...
				<div id="myDropdown2" class="dropdown2-content2">
					<a class="dropmenu" href="myPage_home.do">마이페이지</a> <a
						class="dropmenu" href="myPoint.do">포인트충전</a> <a class="dropmenu"
