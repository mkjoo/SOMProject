...
<body bgcolor="#15183c">
	...
	<form name="changemusic">
		<!-- 오디오 만들기 -->
		<audio id="somAudio" autoplay onended="autoNextSong()"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td rowspan="3"><img id="albumimage" width="45" height="45"
					src="/som/images/myPage/블랙핑크.PNG" /></td>
					...
					<table width="280" height="10" bgcolor="white"
						...
						border-bottom-color: white; overflow-y: scroll; width: 270px; height: 160px; padding: 5px;">
							...
							<c:forEach var="list" items="${musicPlayerList}" varStatus="num">
								<tr>
									<td><input type="hidden" id="songnums"
										value="${list.songnum}" /> <input type="hidden"
										id="songinfor"
										value="${num.index},${list.songnum},${list.path},${list.songname},${list.singer}" />
										<c:set var="songinformation1"
											value="${num.index},${list.songnum},${list.path},${list.songname},${list.singer }"
											scope="page" /> ${num.count}. <a href="#"
