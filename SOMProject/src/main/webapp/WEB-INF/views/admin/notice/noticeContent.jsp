	...
	<div id="board_divide">
		...
		<div id="notice_board" class="admin_tabcontent">
			<form method="post" name="writeForm">
				...
				<table width="230" id="write_btn" style="float:right; margin-top:5px; padding:0">
					<colgroup>
						<col width="75"></col>
						<col width="60"></col>
						<col width="90"></col>
					...
					<tr align="center">
						...
						<td>
							<input type="button" value="삭제" onclick="window.location='adminNoticeDeleteProc.mdo?num=${vo.num}'">
						</td>
						<td>
